...
from MantenimientoLIDARS import (leer_datos_origen, check_file_closed, actualizar_fecha_destino, actualizar_comentario_destino, enviar_correo, \
...
def main():
    ...
    actualizar_sensores_destino(informe_destino, n_equipo, codigo_incidencias, fila_hist, carpeta_destino_historico, ubicacion, hoja_destino_name='Lidar Windcube')
    actualizar_incidencias_destino(informe_destino, n_equipo, codigo_incidencias, fila_hist, carpeta_destino_historico, ubicacion, hoja_destino_name="Lidar Windcube")
...
def main_correo(n_equipo, ubicacion, fecha_ultimomantenimiento, comentario_ultimomantenimiento, operarios_ultimomantenimiento, codigo_incidencias):
    ...
    Siendo los operarios que han realizado el mantenimiento: {operarios_ultimomantenimiento}.
